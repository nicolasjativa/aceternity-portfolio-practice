  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        icon={<AceternityIcon step="Phase 1" />}
        ...
        icon={<AceternityIcon step="Phase 2" />}
        ...
        icon={<AceternityIcon step="Phase 3" />}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 absolute group-hover/canvas-card:opacity-0 transition duration-200 w-full h-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
